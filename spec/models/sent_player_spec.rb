...
RSpec.describe SentPlayer, type: :model do
  ...
  context 'Valid Attributes' do
    ...
    it '3. It should have a player_key attribute' do
      expect(@sentPlayer.player_key).to eq(SentPlayer.first.player_key)
    end
  ...
  context 'Invalid Attributes' do
    it '1. It should not be able to create a model without a player_key' do
      sent_player = SentPlayer.create(trade: Trade.first, player_name: "Test")
      expect(sent_player).to_not be_valid
    end
    it '2. It should not be able to create a model without a player_name' do
      sent_player = SentPlayer.create(trade: Trade.first, player_key: "12345")
      expect(sent_player).to_not be_valid
    end
