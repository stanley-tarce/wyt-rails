...
RSpec.describe 'Teams', type: :request, vcr: true do
  ...
  context '/api/trades **with Bearer Token' do
    it '1. It should return a 200 response' do
      get "/api/trades?league_key=#{User.first.leagues.first.league_key}",
    ...
    it '4. It should update a trade' do
      ...
      @data = {
        ...
        players_to_send: [
          { player_key: @user_roster.first['player_key'], player_name: @user_roster.first['player_name'] },
          { player_key: @user_roster.second['player_key'],
            player_name: @user_roster.second['player_name'] }
        ],
        players_to_receive: [
      ...
      update = {
        players_to_send: [
          { player_key: @user_roster[@user_roster.length - 3]['player_key'],
            player_name: @user_roster[@user_roster.length - 3]['player_name'] },
          { player_key: @user_roster[@user_roster.length - 2]['player_key'],
            player_name: @user_roster[@user_roster.length - 2]['player_name'] }
        ],
        players_to_receive: [
          { player_key: @partner_roster[@partner_roster.length - 3],
            player_name: @partner_roster[@partner_roster.length - 3] },
          { player_key: @partner_roster[@partner_roster.length - 2],
            player_name: @partner_roster[@partner_roster.length - 2] }
        ]
      }
