...
module Api
  class TradesController < ApplicationController
    ...
    def show
      ...
      user = helpers.roster_stats(trade.league.team_key, trade.league.league_key, token)
      partner = helpers.roster_stats(trade.team_key, trade.league.league_key, token)
